...
# Create package
create(path = "c:/users/joelb/google drive/github/glebe.datasets")
...
package_names <- c("haven", "lqmm", "scales", "simstudy", "writexl")
load_packages <- lapply(package_names, require, character.only = TRUE)
...
use_data(dataset1, overwrite = TRUE)
...
# Build package
build("c:/users/joelb/google drive/github/glebe.datasets", path = "c:/users/joelb/google drive/github/r-package-sources")
